                                        ...
                                        <div class="btn-group-vertical" role="group"
                                            ...
                                            @foreach ($question->options as $option)
                                                ...
                                                <label class="btn btn-outline-primary"
                                                    for="btncheck{{ $option->id }}">{{ $option->title }}</label>
                                            @endforeach
                                        </div>
                                    </div>
                                @elseif ($question->type === 'valid/invalid')
                                    <div id="valid_faild_options"
                                        class="d-flex flex-column justify-content-center align-items-center gap-3 p-3">
                                        <button type="button" data-value="vaild"
                                            class="btn btn-light py-3 px-4">Valid</button>
                                        <button type="button" data-value="faild"
                                            class="btn btn-light py-3 px-4">Faild</button>
                                    </div>
