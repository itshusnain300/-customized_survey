...
<main id="main" class="main">
    ...
    <section class="container mt-5">
        ...
        <div class="d-flex justify-content-between align-item-center mb-4">
            <h2 class="">
                <a href="{{ route('customer.user.submitted_vendor.show_diagram', ['user' => Auth::id(), 'vendor_submittion' => $vendor_submittion->id]) }}"
                    class="btn btn-primary">Spider Diagram</a>
            </h2>
        ...
        <div class="answer-box p-4 shadow-sm">
            ...
            <div class="mb-2">
                ...
                @elseif($question->type == 'file')
                <a href="{{ asset('storage/uploads/' . $answer_file) }}" target="_blank" class="btn btn-sm btn-primary">
